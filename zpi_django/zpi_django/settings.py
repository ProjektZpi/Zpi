...
LOGIN_URL = '/autoryzacja/panel_logowania/'
...
# nie chcemy przecinka w floatach dla googlowskich wspl ktore musza miec krope
USE_L10N = False
...
SECRET_KEY = 'nrb5_@)w=ed)e+3-q!o^124-0+rp729_nxz5#nc&amp;x9=feu9fe$'
...
WSGI_APPLICATION = 'zpi_django.wsgi.application'
...
INSTALLED_APPS = (
    ...
    # Uncomment the next line to enable admin documentation:
     ...
     'django.contrib.gis',
     'zpi_django.admin_panel',
     'zpi_django.my_templatetags',
     'zpi_django.cities',
     'zpi_django.events',
     'zpi_django.place',
