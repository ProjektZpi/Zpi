        ...
        if day != 0:
            ...
            if day in self.workouts:
                ...
                if len(self.workouts[day])>1:
                    ...
                    title+="</table>" 
                    body += '<br/><a  id="tooltip_id" class="tooltip" title="'+title+'"><b>'+str(len(self.workouts[day]))+' wydarzenia</b></a>'
                #gdy jest jedno wydarzenie
                    ...
                    if len(self.workouts[day][0].event.name) >10:
                        ...
                        body += '<br/><a id="tooltip_id" href="/wydarzenia/informacje/'+str(self.workouts[day][0].event.id) +'" class="tooltip" title="'+title+'"><b>'+self.workouts[day][0].event.name[0:10]+"...</b></a>"
                    # gdy nazwa jest krotka    
                    else:
                        title="<table id='events'><tr><td>Nazwa:</td><td>Start:</td><td>Miejsce:</td></tr>"
                        title+="<tr><td>"+self.workouts[day][0].event.name+"</td><td>"+self.workouts[day][0].event.start_date.strftime('%Y-%m-%d')+"</td><td>"+self.workouts[day][0].event.place.address+"</td></tr></table>"
                        body += '<br/><a id="tooltip_id" href="/wydarzenia/informacje/'+str(self.workouts[day][0].event.id) +'" class="tooltip" title="'+title+'"><b>'+self.workouts[day][0].event.name+"</b></a>"
